...
namespace Tips
{
    ...
    public class YieldTest
    {
        ...
        public void WithYield()
        {
            ...
            var evens = GetEvenNumbersWithYield(someNumbers);
        ...
        public void ComposingWithYield()
        {
            ...
            var twoAndSix = GetTwoAnd6(GetEvenNumbersWithYield(someNumbers));
        ...
        IList<int> GetEvenNumbers(IEnumerable<int> numbers)
        {
            ...
            {
                Debug.WriteLine($"GetEvenNumbers - {number}");
        ...
        IEnumerable<int> GetEvenNumbersWithYield(IEnumerable<int> numbers)
        {
            foreach (var number in numbers)
            {

                Debug.WriteLine($"GetEvenNumbersUsingYield - {number}");
                if (number % 2 == 0)
                {
